...
export default function ToolbarPlugin({
  ...
  const [imageInsertionType, setImageInsertionType] = useState<
    'inline' | 'regular' | null
  >(null);
  ...
  }, [activeEditor, isLink, setIsLinkEditMode, showModal]);
  ...
  const handleInsertInlineImage = () => {
    setImageInsertionType('inline');
    setIsAssetManagerOpen(true);
  };

  const handleInsertRegularImage = () => {
    setImageInsertionType('regular');
    setIsAssetManagerOpen(true);
  };
  ...
  const handleAssetSelect = (asset: {
    ...
    } else if (imageInsertionType === 'regular') {
          ...
          {canViewerSeeInsertDropdown && (
            <>
              ...
              <DropDown
                ...
                <DropDownItem
                  onClick={handleInsertRegularImage}
                  className="item">
