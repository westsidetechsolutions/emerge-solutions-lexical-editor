...
import './index.css';
import '@lexical/rich-text/styles.css';
import '@lexical/code/styles.css';
import '@lexical/link/styles.css';
import '@lexical/list/styles.css';
import '@lexical/table/styles.css';
import './theme.css';
