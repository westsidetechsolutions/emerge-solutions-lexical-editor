  ...
  "../../node_modules/prettier/parser-babel.js"(exports, module) {
    (function(e) {
      ...
      var G = b((zf, Jr) => {
        ...
        Jr.exports = Tt(typeof globalThis == "object" && globalThis) || Tt(typeof window == "object" && window) || Tt(typeof self == "object" && self) || Tt(typeof global == "object" && global) || /* @__PURE__ */ function() {
          return this;
      ...
      var ws = b((yd, Wi) => {
        ...
        })("versions", []).push({ version: "3.22.2", mode: $l ? "pure" : "global", copyright: "© 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE", source: "https://github.com/zloirock/core-js" });
      });
      var Ns = b((xd, Gi) => {
      ...
      var wn = b((im, Sn) => {
        var Tp = G(), Ep = vn(), Cp = ae(), Rt = vt(), bp = Ze(), vp = bp("toStringTag"), Sp = Tp.Object, wp = Rt(/* @__PURE__ */ function() {
          return arguments;
